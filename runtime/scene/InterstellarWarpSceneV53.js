...
export class InterstellarWarpScene{
 ...
 dispose(){removeEventListener('resize',this.resize);this.warpField.dispose();this.nebulaPass.dispose();this.renderer.dispose();this.renderer.domElement.remove();}
 get performanceStats(){return{pixelRatio:this.renderer.getPixelRatio(),drawCalls:this.renderer.info.render.calls,triangles:this.renderer.info.render.triangles,musicDirection:this.musicDirection,warp:this.warpField.stats};}
}