...
import { WarpFieldManager } from '../warp/WarpFieldManager.js?v=20260813-47';
...
export class InterstellarWarpScene{
 constructor(container){
  ...
  this.renderer=new THREE.WebGLRenderer({antialias:false,powerPreference:'high-performance',alpha:true,premultipliedAlpha:true,stencil:false,depth:true});this.renderer.outputColorSpace=THREE.SRGBColorSpace;this.renderer.toneMapping=THREE.ACESFilmicToneMapping;this.renderer.toneMappingExposure=.64;this.renderer.setClearColor(0x000000,0);this.container.appendChild(this.renderer.domElement);runtimeCapabilities.attachRenderer(this.renderer);
  runtimeCapabilities.mark('postprocessing',true,{version:'6.39.4',active:false,reason:'mobile-dedicated-render-path'});runtimeCapabilities.mark('webgpu-compute',false,{reason:'mobile-dedicated-render-path'});
