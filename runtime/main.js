...
window.__URUX_MODULE_WARMUP__=Promise.allSettled([
 import('./journey/CinematicSelectorV51.js?v=20260814-65.2'),
 import('./journey/CinematicEncounterSystemV65.js?v=20260814-65.2'),
 import('./journey/SecureURUXJourneyAgent.js?v=20260813-10'),
 import('./journey/NebulaDirectiveBridge.js?v=20260812-1')
]);
await import('./mainCoreV53.js?v=20260814-65.2');
